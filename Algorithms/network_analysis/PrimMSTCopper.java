...
public class PrimMSTCopper {
     ...
     */
    public PrimMSTCopper(EdgeWeightedGraph G) {
        numCopper = G.numCopper();
        edgeTo = new Edge[G.V()];
    ...
    private void scan(EdgeWeightedGraph G, int v) {
        ...
        for (Edge e : G.adj(v)) {
            ...
            if (e.weight() < distTo[w] && e.isCopper()) {
                distTo[w] = e.weight();
                edgeTo[w] = e;
    ...
    public boolean isNotSpanningTree()
    {
        return size() < (numCopper - 1);
    }
    ...
    public static void main(String[] args) {
        EdgeWeightedGraph G = new EdgeWeightedGraph("ex1.txt");
        PrimMSTCopper mst = new PrimMSTCopper(G);
        System.out.println("num copp"+ G.numCopper());
        System.out.println("verts in G"+G.V());
        System.out.println("MST size"+mst.size());
        if (mst.isNotSpanningTree())
        {
            System.out.printf("No minimum spanning tree.");
        }
        else
        {
